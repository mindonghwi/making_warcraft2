...
void GALLEYS::init(int nPosX, int nPosY, int nWidth, int nHeight, int nIndexNum)
{
	...
	UNIT::setUnit(UNIT::E_UNIT::E_GALLEYS);
	UNIT::OBJECT::setImage(IMAGEMANAGER->findImage("elvenDestroyerSprite"));
...
void GALLEYS::renderSelected(HDC hdc)
{
...
void GALLEYS::allocateAnimation()
{//금은 +10 나무는 +15
