...
void ELVENARCHER::init(int nPosX, int nPosY, int nWidth, int nHeight, int nIndexNum)
{
	...
	UNIT::setUnit(UNIT::E_UNIT::E_ARCHER);
	UNIT::OBJECT::setImage(IMAGEMANAGER->findImage("elvenArcherSprite"));
...
void ELVENARCHER::updateBehavier()
{
...
void ELVENARCHER::allocateBehavier()
{
...
void ELVENARCHER::allocateAnimation()
{
