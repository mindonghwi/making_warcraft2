...
void SUBMARIN::init(int nPosX, int nPosY, int nWidth, int nHeight, int nIndexNum)
{
	...
	UNIT::setUnit(UNIT::E_UNIT::E_SUBMARIN);
	UNIT::OBJECT::setImage(IMAGEMANAGER->findImage("gnomishSubmarine"));
...
void SUBMARIN::renderSelected(HDC hdc)
{
...
void SUBMARIN::allocateBehavier()
{
...
void SUBMARIN::allocateAnimation()
{//금은 +10 나무는 +15
