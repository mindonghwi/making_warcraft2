...
void BATTLESHIP::init(int nPosX, int nPosY, int nWidth, int nHeight, int nIndexNum)
{
	...
	UNIT::setUnit(UNIT::E_UNIT::E_BATTLESHIP);
	UNIT::OBJECT::setImage(IMAGEMANAGER->findImage("battleShipSprte"));
...
void BATTLESHIP::updateBehavier()
{
...
void BATTLESHIP::renderSelected(HDC hdc)
{
...
void BATTLESHIP::allocateBehavier()
{
...
void BATTLESHIP::allocateAnimation()
{//금은 +10 나무는 +15
